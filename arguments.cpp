...
int         CArguments::GetArgumentAsIntOr(const char* pch_indicator, int value) 
{
    if (GetArgumentIsDefined(pch_indicator)) 
    {
        return GetArgumentAsInt(pch_indicator);
    } else {
        return value;
    }
}
...
const char* CArguments::GetArgumentAsStringOr(const char* pch_indicator, const char* value)
{
    if (GetArgumentIsDefined(pch_indicator)) 
    {
        return GetArgumentAsString(pch_indicator);
    } else {
        return value;
    }
...
double      CArguments::GetArgumentAsDoubleOr(const char* pch_indicator, double value)
{
    if (GetArgumentIsDefined(pch_indicator)) 
    {
        return GetArgumentAsDouble(pch_indicator);
    } else {
        return value;
    }
}
